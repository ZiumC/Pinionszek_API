...
namespace Pinionszek_API.Migrations
{
    ...
    [Migration("20240309114555_FixedReferencesBetweenPaymentsAndSharedPayments")]
    partial class FixedReferencesBetweenPaymentsAndSharedPayments
    {
            ...
            modelBuilder.Entity("Pinionszek_API.Models.DatabaseModel.SharedPayment", b =>
                {
                    ...
                    b.HasOne("Pinionszek_API.Models.DatabaseModel.Payment", "Payment")
                        .WithOne("SharedPayment")
                        .HasForeignKey("Pinionszek_API.Models.DatabaseModel.SharedPayment", "IdPayment")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
